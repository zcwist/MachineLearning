def learnWithOut(num):

	fileHandler = open("midData/FVWithoutNo.%d.txt" %num);
	vectors = []
	...
	print "Err numbers:%d Iteration Times:%d" %(err, count)
	...
	fileHandler = open("midData/weights.txt",'w')
